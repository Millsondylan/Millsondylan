...
## Skills
- **Languages**: Go, Python, TypeScript, Dart, Kotlin, Shell
- **Frameworks & Libraries**: Bubble Tea, Cobra, GoReleaser, FastAPI, Flutter, React Native, Supabase, Anthropic & OpenAI SDKs
- **DevOps**: GitHub Actions (matrix testing, auto-merge gates, mobile deploys), Homebrew packaging, Docker, Render, Supabase migrations
